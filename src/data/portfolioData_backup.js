...
export const portfolioData = [
    ...
    userResearch: {
        ...
        howMightWeStatements: [
            "How might we make enrolling in an after-school program simple and enjoyable for parents?",
            "How might we help parents keep their kids engaged while they're busy with work?",
            "How might we make enrolling for an after-school program feel as fast and seamless as ordering a ride?",
            "How might we completely eliminate physical visits and paper documentation when parents enroll their kids in after-school programs?"
        ]
    },
        ...
        findings: [
            {
                ...
                issue: "Parents want brief info under each program title.",
                designChange: "Added short descriptions and key details (age range, time, price) under each program card."
            },
            {
                title: "Different pickup times for different days",
                issue: "Parents wanted different pickup times on different days.",
                designChange: "Introduced a flexible weekly schedule where pickup can be set per weekday."
            },
            {
                title: "Making Installment payment",
                issue: "Some parents preferred installment payments.",
                designChange: "Added an installment payment option with clear breakdowns."
            },
            {
                title: "Option to pause current program or order",
                issue: "Parents wanted to pause a program easily.",
                designChange: "Added a prominent 'Pause Program' action in the enrollment management screen."
            }
        ],
